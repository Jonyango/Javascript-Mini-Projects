...
const keyboard={
   ...
   init(){
       ...
       //selecting all the elements with keyboard__key class and storing them in the keys array.
   ...
   _toggleCapsLock() {
    ...
    //Looping through our nodelist checking that the element doesn't contain another element
